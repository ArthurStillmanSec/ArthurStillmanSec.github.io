...
<ul>
  <li>Lead B2B and retail operations, enforcing strict chain-of-custody protocols.</li>
  <li>Manage physical access control and inventory integrity for global shipments.</li>
</ul>
...
<ul>
  <li>Analyzed high-volume data streams to enforce platform safety policies.</li>
  <li>Acted as a human firewall for platform integrity and risk mitigation.</li>
</ul>
...
<ul>
  <li>Directed technical support teams prioritizing network continuity for B2B clients.</li>
  <li>Enforced strict SLAs to minimize downtime and optimize performance.</li>
</ul>

<br>

<h4>🏥 VCS Medical Associates | Sales Team Lead</h4>
<i>2018 - 2020</i>
<ul>
  <li>Managed a medical unit under strict HIPAA privacy and compliance standards.</li>
</ul>

<br>

<h4>🕒 Earlier Career History</h4>
<ul>
  <li><b>Local Search Group:</b> SEO Consultant (2018)</li>
  <li><b>Black Swan K-9:</b> Client Liaison Manager (2017-2018)</li>
  <li><b>Life1 Medical Alarm:</b> Device Sales & Compliance (2016)</li>
  <li><b>SYCN Auto Logistics:</b> Transport Broker (2011-2013)</li>
</ul>
...
<ul>
  ...
  <li><b>Current Focus:</b> A+ Hardware & Intro to IT.</li>
</ul>
